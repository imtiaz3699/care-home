...
<Swiper className="mySwiper w-full h-full relative">
    ...
    <div className="flex flex-col items-center py-20 gap-10">
      <h1 className="text-[35px] font-bold text-blue-800">What sets us Apart</h1>
     
     
      <div className="flex flex-row items-center gap-10">
        <div className="w-[500px] h-[400px] drop-shadow-2xl border-4 border-blue-800 rounded-xl shadow-slate-800">
      ...
      <div className="flex flex-col  w-[450px] gap-3">
