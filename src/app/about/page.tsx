      ...
      <div className='py-10 container- mx-auto flex flex-row  justify-center gap-10'>
    {
        ourCare.map((element,idx)=> {
            return <div className='flex flex-col items-center gap-4'>
                <div className='w-[200px] h-[200px] rounded-full drop-shadow-2xl shadow-2xl overflow-hidden'>
...
<div className='py-20 flex flex-row justify-center'>
    <div className='bg-yellow-100 p-4 border border-green-800 rounded-xl w-[800px]'>
        <div className='text-[20px] text-green-800'>Every SBH Residence operates based on a care philosophy that mandates the provision of a secure and cozy setting for all inhabitants. Our commitment entails treating everyone with honor and impartiality, regardless of their requirements and histories, within an ambiance of confidence and recognition.</div>
        <br />
...
<div className='py-20 flex flex-row items-center justify-center bg-yellow-100 gap-20'>
